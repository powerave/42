...
import { disconnectDB } from "./services.js";
...
// charging secrets
const tlsOptions = {
	key: fs.readFileSync('/run/secrets/service_storage_key'),
	cert: fs.readFileSync('/run/secrets/service_storage_crt'),
...
server.on('listening', () => {
  ...
  console.log('Service storage listening on ' + bind);
});
